...
function loadQuotes() {
  ...
  array_quotes.push({ quote: "Science isn't about why! It’s about why not!", character: "Cave Johnson" })
  ...
  array_quotes.push({ quote: "We both said a lot of things that you're going to regret. But I think we can put our differences behind us. For science. You monster.", character: "GLaDOS" })
  array_quotes.push({ quote: "Home? We can't go home. There's a line men like us have to cross. If we're lucky, we do what's necessary, then we die. No, all I really want, Captain, is peace.", character: "John Konrad" })
  ...
  array_quotes.push({ quote: "It's more important to master the cards you're holding than to complain about the ones your opponents were dealt.", character: "Grimsley" })
  array_quotes.push({ quote: "Sorry, I'm married. Can't blame you for wantin' me, though.", character: "Hawkeye" })
  array_quotes.push({ quote: "Death is inevitable. Our fear of it makes us play safe, blocks out emotion. It's a losing game. Without passion, you are already dead.", character: "Max Payne" })
  ...
  array_quotes.push({ quote: "Jeremy. Someday, people will tell you about your father. For that, I'm sorry. I love you.", character: "John Konrad" })
  ...
  array_quotes.push({ quote: "Boss... you were right. It's not about changing the world. It's about doing our best to leave the world... the way it is. It's about respecting the will of others, and believing in your own.", character: "Big Boss" })
  array_quotes.push({ quote: "NOTHING IS MORE BADASS THAN TREATING A WOMAN WITH RESPECT!", character: "Mr. Torgue" })
  array_quotes.push({ quote: "You are not a good person. You know that, right? Good people don't end up here.", character: "GLaDOS" })
  array_quotes.push({ quote: "A MadWorld... I'll fit right in.", character: "Jack Cayman" })
